  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="padding-top: 50px;padding-bottom: 50px;overflow: auto;">
        ...
        <input type="text" name="kategorieditp" value="<?php echo $k->nama_kategori ?>">
        <br>
        <br>
        <br>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="padding-top: 50px;padding-bottom: 50px;overflow: auto;">
        ...
        <span style="visibility: hidden;">Rp. </span><input type="text" name="kategorip" placeholder="Contoh : Kaos">
        <br>
        <br>
        <br>
